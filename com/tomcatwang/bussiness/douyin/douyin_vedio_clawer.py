...
class DouYin(object):
    def __init__(self, width=500, height=300):
        ...
        chrome_options.add_argument(
            'user-agent="Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.87 Safari/537.36"')
        self.driver = Browser(driver_name=r'chrome', executable_path=r'C:\Users\tomcatwang\Desktop\yinliu\chromedriver.exe', options=chrome_options,
                              headless=True)
    ...
    def get_video_urls(self, user_id):
        ...
        while unique_id != user_id:
            ...
            search_url ='https://aweme-lq.snssdk.com/aweme/v1/discover/search/?os_api=22&device_type=r8207&device_platform=android&ssmix=a&iid=96236324401&manifest_version_code=840&dpi=240&uuid=865166025762330&version_code=840&app_name=aweme&version_name=8.4.0&ts=1581145639&openudid=a95bb4e3a52338bd&device_id=39531304211&resolution=1600*900&os_version=5.1.1&language=zh&device_brand=oppo&app_type=normal&ac=wifi&update_version_code=8402&aid=1128&channel=aweGW&_rticket=1581138176167&mcc_mnc=46000'
            #postdata={'name':'xiaochong'}
            #r=requests.post(url=search_url, verify=False,headers=headers)
            #print(r.text)
